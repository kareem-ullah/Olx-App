...
function SignupLog() {
    ...
    const [credentials, setCredentials] = useState({ name: "", email: "", password: "", contact: "", city: "",uid:"" });
            ...
            >
                ...
                <Modal.Body>
                    ...
                    <div style={{ paddingBottom: '15px' }}>
                        ...
                        <Input.Password placeholder="Enter Password" prefix={<LockOutlined style={{ fontSize: '20px' }} />}
